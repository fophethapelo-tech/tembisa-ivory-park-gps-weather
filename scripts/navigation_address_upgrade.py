...
if 'id="navigatorName"' not in s:s=s.replace(old,new,1)
...
s=s.replace("format:'jsonv2',limit:'8',countrycodes:'za',addressdetails:'1',dedupe:'1',q:q,layer:'address,poi,highway',layer:'address,poi,highway'","format:'jsonv2',limit:'8',countrycodes:'za',addressdetails:'1',dedupe:'1',q:q,layer:'address,poi,highway'")
...
if 'function navSpeak(' not in s:
    marker="function speak(text,force=false){";start=s.find(marker);end=s.find('\n',start)
